...
def get_network_model(lr=1e-3):
	...
	conv2 = Conv2D(16,(3,3),activation='relu',padding='same', kernel_initializer = 'he_normal')(drop1)
	...
	conv3 = Conv2D(32,(3,3),activation='relu',padding='same', kernel_initializer = 'he_normal')(drop2)
	drop3 = Dropout(0.5)(conv3)

	out   = Conv2D(1,(3,3),activation='sigmoid',padding='same', kernel_initializer = 'he_normal')(drop3)
